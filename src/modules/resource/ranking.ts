        ...
        { 
            ...
            { 
                ...
                list_ta.push(wmsrv.wm5.protobuf.Ranking.Entry.create({ 
                    ...
                    name: car_ta?.name ?? 'ＧＵＥＳＴ',
                    regionId: car_ta?.regionId ?? 1,
                    model: car_ta?.model ?? 0,
                    visualModel: car_ta?.visualModel ?? 0,
                    defaultColor: car_ta?.defaultColor ?? 0,
