...
export interface GameOptions 
{
    ...
    // Custom grant options for new cars
    ...
    grantStickerTonewCar?: number;

    // List of CarItem rewards to grant when a new car is registered.
    createCarRewards?: Array<{ category: number; itemId: number; amount: number }>;
}
